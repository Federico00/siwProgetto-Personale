package com.MyHotel.autentication;
...
import static com.MyHotel.model.Credentials.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/home",  "/hotelAll/**", "/stanzaAll/**", "/pacchettoAll/**",  
                        "/login", "/registerUser/**", "/register/**",  "/css/**","/js/**", "/images/**").permitAll()
